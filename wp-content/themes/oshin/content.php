...
$is_tastu_output = ( $blog_attr['style'] == 'shortcodes' && ((isset( $blog_attr['hide_thubnail'] ) && ! $blog_attr['hide_thubnail']) || !isset( $blog_attr['hide_thubnail'] )) ) ? true : false;
if ( ! empty( $url ) && ( ( ! is_single() || ! $is_wide_single ) && $blog_attr['style'] != 'shortcodes' ) || $is_tastu_output ) : ?>
