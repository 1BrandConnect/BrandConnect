...
if (!function_exists('oshine_animated_link')) {
    function oshine_animated_link( $atts, $content, $tag ) {
		...
		$output .= '<div '.$css_id.' class="oshine-animated-link '.$custom_class_name.' oshine-module align-'. $alignment .' '.$animate.' '.$visibility_classes.' '.$css_classes.'" '.$data_animations.'><a class = "animated-link animated-link-'. $link_style .'" ' . $new_tab . ' href = "'. $url .'">';
